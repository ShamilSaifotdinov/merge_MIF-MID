...
class MergeGeoms:
    ...
    def __init__(self, srcLayer):
        # Instance variables
        self.geomPolygon = ogr.Geometry(ogr.wkbMultiPolygon)
        self.geomPolyline = ogr.Geometry(ogr.wkbMultiLineString)
        self.geomMultiPoint = ogr.Geometry(ogr.wkbMultiPoint)
